...
def get_args():
    parser = argparse.ArgumentParser(
        description="This script is used to evaluate the face detector on WIDER face dataset",
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="IOU threshold used to determine whether the prediction is matched the ground truth, should be float between 0 and 1"
    )
